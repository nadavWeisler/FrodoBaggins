...
jsPsych.plugins.instructions = (function () {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      direction: {
        ...
        default: '',
        description: 'The direction in which the text should be read. Options include "ltr" (left to right) and "rtl" (right to left).'
      }
    }
  }
  ...
  plugin.trial = function (display_element, trial) {
    ...
    function show_current_page() {
      ...
      display_element.style.direction = trial.direction;
