    ...
    plugin.trial = function(display_element, trial) {
        ...
        setTimeout(function() {
            ...
            function isCorrect(answer) {
                if (trial.right_up.includes(answer) && (stimulus_side == '0' || stimulus_side == '2')) {
                    return true;
                } else if (trial.left_down.includes(answer) && (stimulus_side == '1' || stimulus_side == '3')) {
                    return true
                } else {
                    return false;
                }
            ...
            const end_trial = function() {
                ...
                setTimeout(function() {
                    ...
                    console.log(keyPress, response.key);
